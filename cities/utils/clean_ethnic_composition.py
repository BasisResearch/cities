...
def clean_ethnic_composition():
    ...
    ethnic_composition['other_race_races'] = ethnic_composition['other_race'] + ethnic_composition['two_or_more_sum']
    ethnic_composition = ethnic_composition.drop(['other_race', 'two_or_more_sum'], axis=1)
    ...
    ethnic_composition.iloc[:, 3:] = ethnic_composition.iloc[:, 3:].div(row_sums, axis=0)
    ...
    ethnic_composition_wide.to_csv("../data/processed/ethnic_composition_wide.csv", index=False)
    ethnic_composition_long.to_csv("../data/processed/ethnic_composition_long.csv", index=False)
    ethnic_composition_std_wide.to_csv("../data/processed/ethnic_composition_std_wide.csv", index=False)
    ethnic_composition_std_long.to_csv("../data/processed/ethnic_composition_std_long.csv", index=False)