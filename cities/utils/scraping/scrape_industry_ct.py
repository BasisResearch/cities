...
variables = "NAME,DP03_0004E,DP03_0033E,DP03_0034E,DP03_0035E,DP03_0036E,DP03_0037E,DP03_0038E,DP03_0039E,DP03_0040E,DP03_0041E,DP03_0042E,DP03_0043E,DP03_0044E,DP03_0045E"
...
industry['GeoFIPS'] = industry.apply(lambda row: f"{row['state']}{row['county']}{row['tract']}", axis=1).astype(np.int64)
...
assert industry[industry['GeoName'] == 'Unknown'].shape[0] == 0, 'There are Unknown GeoNames'
...
for i in range(len(industry_list)):
    ...
    industry_singl[columns_to_convert] = industry_singl[columns_to_convert].astype(float)
