...
def clean_urbanicity_initially():
    ...
    population_urban = pd.read_csv(f"{root}/data/raw/DECENNIALDHC2020.P2-2023-12-25T165149.csv")
    ...
    housing_urban = pd.read_csv(f"{root}/data/raw/DECENNIALDHC2020.H2-2023-12-25T174403.csv")
...
def clean_urbanicity_ma():
    ...
    cleaner = VariableCleanerMSA(variable_name="urbanicity",
