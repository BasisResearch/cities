...
def clean_hazard_first():
    ...
    hazard.columns = ['GeoFIPS', 'GeoName', 'Expected_agricultural_loss_rate', 'Expected_building_loss_rate',
                    'Expected_population_loss_rate', 'Diesel_particulate_matter_exposure',
                    'Proximity_to_hazardous_waste_sites', 'Proximity_to_Risk_Management_Plan_facilities']
