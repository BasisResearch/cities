...
def clean_industry():
    ...
    gdp["GeoFIPS"].unique(), industry["GeoFIPS"].unique()
    )

    industry = industry[
    industry["GeoFIPS"].isin(common_fips)
    ] 
    ...
    industry = industry[['GeoFIPS', 'GeoName', 'DP03_0004E',
                         'DP03_0033E', 'DP03_0034E', 'DP03_0035E',
                         'DP03_0036E', 'DP03_0037E', 'DP03_0038E',
                         'DP03_0039E', 'DP03_0040E', 'DP03_0041E',
                         'DP03_0042E', 'DP03_0043E', 'DP03_0044E',
                         'DP03_0045E']]
